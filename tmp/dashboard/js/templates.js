angular.module('dashboard-web-page-app-templates', []).run(['$templateCache', function($templateCache) {
  $templateCache.put("dashboard/templates/sign-creator.tpl",
    ...
    "                                <textarea ng-model=\"sign.headline\" field=\"headerAsset.Value.Title\" class=\"form-control\" rows=\"15\" id=\"comment\" maxlength=180 focus-on=\"mainTextArea\" placeholder=\"Say anything you\\'d like to say!\"></textarea>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                        <!-- Preview container -->\n" +
    "                        <div class=\"col-md-8\">\n" +
    ...
    "                                <div class=\"preview\">\n" +
    "                                    <div class=\"preview-wrapper\" ng-class=\"landscapePreview ? 'portrait' : 'landscape'\">\n" +
    "                                        <!-- landscape preview -->\n" +
